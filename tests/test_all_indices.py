...
from nlp.syntacticComplexity.maxPhraseLength import maxPhraseLength
...
from nlp.semantic_coherence import semantic_coherence
...
def run_all_tests():
    ...
    results_dict = {}
    test_dir('data/control_data', concept_dict, results_dict)
    test_dir('data/patient_data', concept_dict, results_dict)
    return results_dict
